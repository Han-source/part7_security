...
public class PostController {
	...
	@PreAuthorize("isAuthenticated()") //현재 사용자가 로그인 처리를 했는지
	...
	public String registerPost(@AuthenticationPrincipal Principal principal,
		...
		Party writer = cu.getCurUser(); // 함수 호출시 Party.Writer가 호출이 된다. 
	...
	@PreAuthorize("principal.getCurUser().userId == #") //현재 사용자가 로그인 처리를 했는지
